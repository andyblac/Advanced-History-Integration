export default {
  ...
  "comparison_settings": "Vergelijkingsinstellingen",
  "show_comparison_banner": "Vergelijkingsbanner",
  "comparison_options": "Vergelijkingsopties",
  ...
  "clear_axis_targets_title": "Doelen wissen?",
  "clear_axis_targets_message": "Alle doelen en filters van deze as wissen?",
  ...
  "y2_broad_target_warning": "Brede doelen op Y2 kunnen verschillende meettypen bevatten en onverwachte resultaten opleveren. Gebruik het filter Type om één type te selecteren, zoals Temperatuur.",
  ...
  "enable_axis_running_total": "Compatibele doelen van {axis} als oplopende totalen tonen",
  "disable_axis_running_total": "Doelen van {axis} niet langer als oplopende totalen tonen",
  ...
  "running_total_export_warning": "Oplopend totaal is voor dit paneel ingeschakeld. Dit is een weergaveoptie van Advanced History die niet wordt ondersteund door de native Statistics Graph Chart Card en daarom niet in de geëxporteerde kaart wordt opgenomen.",
  ...
  "auto_hide_date_picker": "Automatisch verbergen"
};
