export default {
  ...
  "show_comparison_banner": "Comparison banner",
  "comparison_options": "Compare options",
  ...
  "clear_axis_targets_title": "Clear targets?",
  "clear_axis_targets_message": "Clear all targets and filters from this axis?",
  ...
  "show_detail_banner": "Show detail banner",
  ...
  "y2_broad_target_warning": "Broad targets on Y2 may include different measurement types and produce unexpected results. Use the Type filter to select one type, such as Temperature.",
  ...
  "add_current_chart_to_dashboard": "Add current chart to dashboard",
  "dashboard_card_editor_unavailable": "The Statistics Graph Chart Card editor is unavailable.",
  ...
  "running_total_export_warning": "Running Total is enabled for this panel. It is an Advanced History display option and is not supported by the native Statistics Graph Chart Card, so it will not be included in the exported card.",
  ...
  "compare_previous_day": "Yesterday",
  "compare_previous_week": "Last week",
  "compare_previous_month": "Last month",
