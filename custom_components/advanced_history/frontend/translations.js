const TRANSLATIONS = {
  "en-US": {
    ...
    "configure_series": "Choose graph series for {target}",
    "series_settings": "Graph series: {target}",
    "series_settings_note": "Choose the entity state and attributes to display. For categorical attributes, enter the recorded values that should appear in the timeline.",
  ...
  "de": {
    ...
    "configure_series": "Diagrammreihen für {target} auswählen",
    "series_settings": "Diagrammreihen: {target}",
    "series_settings_note": "Wähle den Entitätszustand und die anzuzeigenden Attribute aus. Gib bei kategorialen Attributen die aufgezeichneten Werte ein, die in der Zeitleiste erscheinen sollen.",
  ...
  "es": {
    ...
    "configure_series": "Elegir series del gráfico para {target}",
    "series_settings": "Series del gráfico: {target}",
    "series_settings_note": "Elige el estado de la entidad y los atributos que se mostrarán. Para los atributos categóricos, introduce los valores registrados que deben aparecer en la cronología.",
  ...
  "fr": {
    ...
    "configure_series": "Choisir les séries du graphique pour {target}",
    "series_settings": "Séries du graphique : {target}",
    "series_settings_note": "Choisissez l’état de l’entité et les attributs à afficher. Pour les attributs catégoriels, saisissez les valeurs enregistrées à afficher dans la chronologie.",
  ...
  "it": {
    ...
    "configure_series": "Scegli le serie del grafico per {target}",
    "series_settings": "Serie del grafico: {target}",
    "series_settings_note": "Scegli lo stato dell’entità e gli attributi da visualizzare. Per gli attributi categoriali, inserisci i valori registrati da mostrare nella cronologia.",
  ...
  "nl": {
    ...
    "configure_series": "Grafiekreeksen voor {target} kiezen",
    "series_settings": "Grafiekreeksen: {target}",
    "series_settings_note": "Kies de entiteitsstatus en kenmerken die moeten worden weergegeven. Voer voor categorische kenmerken de opgeslagen waarden in die op de tijdlijn moeten verschijnen.",
  ...
  "pt-BR": {
    ...
    "graph_editor_note": "Estas são as configurações do Statistics Graph Chart Card. Os alvos continuam sendo gerenciados pela página Histórico; as entradas de entidades controlam aqui sua aparência no gráfico. Use Adicionar entidade e o campo Atributo para mostrar um ou mais atributos de uma entidade.",
    ...
    "configure_series": "Escolher séries do gráfico para {target}",
    "series_settings": "Séries do gráfico: {target}",
    "series_settings_note": "Escolha o estado da entidade e os atributos a apresentar. Para atributos categóricos, introduza os valores registados que devem aparecer na linha temporal.",
