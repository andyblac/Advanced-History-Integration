const TRANSLATIONS = {
  "en-US": {
    ...
    "graph_editor_note": "These are the Statistics Graph Chart Card settings. Targets remain managed by the History page; entity entries here control their graph appearance.",
  ...
  "de": {
    ...
    "graph_editor_note": "Dies sind die Einstellungen der Statistics Graph Chart Card. Ziele werden weiterhin auf der Verlaufsseite verwaltet; die Entitätseinträge hier steuern ihre Darstellung im Diagramm.",
  ...
  "es": {
    ...
    "graph_editor_note": "Estos son los ajustes de Statistics Graph Chart Card. Los objetivos se siguen gestionando desde la página Historial; las entradas de entidades controlan aquí su apariencia en el gráfico.",
  ...
  "fr": {
    ...
    "graph_editor_note": "Voici les paramètres de Statistics Graph Chart Card. Les cibles restent gérées depuis la page Historique ; les entrées d’entités contrôlent ici leur apparence dans le graphique.",
  ...
  "it": {
    ...
    "graph_editor_note": "Queste sono le impostazioni di Statistics Graph Chart Card. Gli obiettivi restano gestiti dalla pagina Cronologia; le voci delle entità ne controllano qui l’aspetto nel grafico.",
  ...
  "nl": {
    ...
    "graph_editor_note": "Dit zijn de instellingen van Statistics Graph Chart Card. Doelen blijven beheerd via de pagina Geschiedenis; de entiteitsvermeldingen bepalen hier hun weergave in de grafiek.",
  ...
  "pt-BR": {
    ...
    "graph_editor_note": "Estas são as configurações do Statistics Graph Chart Card. Os alvos continuam sendo gerenciados pela página Histórico; as entradas de entidades controlam aqui sua aparência no gráfico.",
