...
- Show Home Assistant-style current and target attributes automatically for climate, humidifier, and water-heater entities in both History and More Info.
...
1. Install Statistics Graph Chart Card **v3.32 or newer** and register it as a dashboard resource.
